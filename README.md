...
<p><img src="descarga.jfif"  text-align="center"></p>
		...
		<p><font size="5" color="black"> En esta evaluación aprendimos lo que eran las <span class="h-j">Fake News</span> e incluso nos inventamos una. Recuerdo que en mi grupo preparamos una en la que anunciabamos la rotura del matrimonio entre el Príncipe Harry y Meghan Markle. 
		</p>
<p><font size="5" color="black">También estudiamos la <strong>evolución de las TIC, </strong> mi grupo en concreto hizo un trabajo sobre la evolución de los teléfonos <a href="shorturl.at/hqryE">(Link al trabajo)</a></p></font>
<p><font size="5" color="white">También aprendimos el significado de muchas palabras como inteligencia artificial, nanotecnología, domótia, reconocimientos, biotecnología, cloud, GIMPS, geolocalización, redes sociales, criptografía...
		

<br>
		<b><p id="evaluacion2"><font color="black" size="7"> Evaluación 2<img src="https://www.pinterest.es/pin/505388389431909994/"></p></font> </b> 

		<p><font size="5" color="black">Estudiamos el <span class="h-j">MODELO OSI</span> con todas sus diferentes capas, cada grupo hizo una capa, y son las siguientes: </p></font>
				<p> 
					<table font color="black" border="5">
<tr>
					<th><font size="6" color="black">Niveles
					</th>

					<th><font size="6" color="black">Función
					</th></font>
				</tr>

				<tr>
					<td><font size="5"color="black"> 1</td>
						<td><font size="5"color="black">Física</td>

						</tr>	

						<tr>	
							<td><font size="5"color="black"> 2 </td>
								<td><font size="5" color="black">Enlace de  Datos</td>
								</tr>

								<tr>	
									<td><font size="5"color="black">3</td>
										<td><font size="5" color="black">Red</td>
										</tr>		
<tr>	
									<td><font size="5"color="black">4</td>
										<td><font size="5" color="black">Transporte</td>
										</tr>	
										<tr>	
									<td><font size="5"color="black">5</td>
										<td><font size="5" color="black">Sesión</td>
										</tr>	
										<tr>	
									<td><font size="5"color="black">6</td>
										<td><font size="5" color="black">Presentación</td>
										</tr>	
										<tr>
											<td><font size="5"color="black"> 7 </td>
												<td><font size="5" color="black">Aplicación</td>
												</tr>	
